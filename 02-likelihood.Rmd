...
```{r, echo = FALSE}
df <- read_csv("https://raw.githubusercontent.com/agricolamz/2021_da4l/master/data/Coretta_2017_icelandic.csv")
...
lnorm_params <- fitdist(vowel_dur, distr = 'lnorm', method = 'mle')
norm_params <- fitdist(vowel_dur, distr = 'norm', method = 'mle')
